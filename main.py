...
# Ảnh Anime ngầu lòi độc quyền, chuẩn link Discord không lo mất ảnh
ITACHI_IMAGE_URL = (
...
# --- MODAL 1: SPAM SERVER (HỖ TRỢ FULL VĂN BẢN 500+ CHỮ) ---
class ModalSpamServer(discord.ui.Modal, title="⚡ SPAM KÊNH SERVER (ITACHI)"):

  noi_dung = discord.ui.TextInput(
      label="Nhập nội dung chữ muốn spam (hỗ trợ 500+ chữ)",
      placeholder="Nhập nội dung dài tùy ý vào đây...",
  ...
  async def on_submit(self, interaction: discord.Interaction):
    ...
    # Đưa trực tiếp toàn bộ nội dung (500+ chữ) ra ngoài content tin nhắn thay vì ép gọn trong khung
    tasks = [
...
# --- MODAL 2: SPAM DM (HỖ TRỢ FULL VĂN BẢN 500+ CHỮ) ---
class ModalSpamDM(discord.ui.Modal, title="🎯 SPAM DM (ITACHI)"):

  noi_dung = discord.ui.TextInput(
      label="Nhập nội dung chữ gửi hòm thư (hỗ trợ 500+ chữ)",
      placeholder="Nhập nội dung dài tùy ý vào đây...",
      style=discord.TextStyle.paragraph,
      required=True,
  )
...
class ModalTreoMay(discord.ui.Modal, title="🛡️ TREO MÁY DÀI HẠN (1 - 5 TIẾNG)"):
  ...
  noi_dung = discord.ui.TextInput(
      label="Nhập nội dung chữ treo ngầm (hỗ trợ 500+ chữ)",
      placeholder="Nhập nội dung dài tùy ý...",
      style=discord.TextStyle.paragraph,
      required=True,
  )
