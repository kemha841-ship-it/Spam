...
class ModalTreoGio(discord.ui.Modal, title="🛡️ CẤU HÌNH HỆ THỐNG TREO NGẦM"):
  ...
  nghi_giay = discord.ui.TextInput(
      label="Số giây nghỉ giữa mỗi tin (Ví dụ: 2 giây)",
  ...
  @discord.ui.select(
      ...
      options=[
          discord.SelectOption(
              ...
              description="Mở bảng nhập nội dung & số lượng",
              emoji="⚡",
              value="spam_server",
          ),
          discord.SelectOption(
              label="2. Spam Tin Nhắn Riêng (DM)",
              description="Mở bảng nhập oanh tạc hòm thư mục tiêu",
              emoji="🎯",
              value="spam_dm",
          ),
          discord.SelectOption(
